...
namespace Inventory
{
	...
	void Initialize(AFortPlayerControllerAthena* PlayerController)
	{
        ...
        AddNewItem(PlayerController, Wood, 0, EFortQuickBars::Secondary, 1337);
        AddNewItem(PlayerController, Stone, 0, EFortQuickBars::Secondary, 1337);
        AddNewItem(PlayerController, Metal, 0, EFortQuickBars::Secondary, 1337);

        AddNewItem(PlayerController, Rockets, 0, EFortQuickBars::Secondary, 1337);
        AddNewItem(PlayerController, Shells, 0, EFortQuickBars::Secondary, 1337);
        AddNewItem(PlayerController, Medium, 0, EFortQuickBars::Secondary, 1337);
        AddNewItem(PlayerController, Light, 0, EFortQuickBars::Secondary, 1337);
        AddNewItem(PlayerController, Heavy, 0, EFortQuickBars::Secondary, 1337);
        ...
        static auto Pickaxe = UObject::FindObjectFast<UFortWeaponItemDefinition>("/Game/Athena/Items/Weapons/WID_Harvest_Pickaxe_Teslacoil_Athena.WID_Harvest_Pickaxe_Teslacoil_Athena");
        ...
        static auto Pump = UObject::FindObjectFast<UFortWeaponItemDefinition>("/Game/Athena/Items/Weapons/WID_Shotgun_Standard_Athena_UC_Ore_T03.WID_Shotgun_Standard_Athena_UC_Ore_T03");
